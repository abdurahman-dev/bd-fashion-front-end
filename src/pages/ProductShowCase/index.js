...
const ProductShowCase = () => {
  ...
  const handleFeatureChange = (e) => {
    ...
    if (e === 'default') {
    ...
    } else if(e === 'onSale' || e === 'trending' || e === 'flashSale' || e === 'new'){
      ...
      pSlug.sort()
      const stPd=[]
      const p= pSlug.forEach((item,i)=> stPd[i]= catProducts.find((pd,i)=> pd.slug === item))
      // ascending
      if(e=== "ascending"){
        setProduct(stPd);
        if(stPd.length <= "2"){
                ...
                <div>
                  <div>
                    ...
                    <select
                      ...
                      style={{border:'2px solid #fff', borderRadius:'3px'}} className='focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent'>
